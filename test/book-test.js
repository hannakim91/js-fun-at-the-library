...
describe("book.js", function () {
  ...
  //   it("should create a second character object", function () {
  //     var warewolfCharacter = buildMainCharacter("Debbie", 146, "she/her");
  //     assert.equal(warewolfCharacter.name, "Debbie");
  //     assert.equal(warewolfCharacter.age, 146);
  //     assert.equal(warewolfCharacter.pronouns, "she/her");
  //   });
  });
